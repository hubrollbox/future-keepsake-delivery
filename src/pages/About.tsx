      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          <div className="flex justify-center mb-8">
            <img src="/keepla-logo-red.svg" alt="Logo" width={80} height={80} className="drop-shadow-sm" />
          </div>
        ...
        <div className="mb-16">
          <div className="emotion-card p-12 max-w-5xl mx-auto text-center">
            <img src="/keepla-logo-red.svg" alt="Logo" style={{width: 80, height: 80, margin: '0 auto 2rem auto'}} />
