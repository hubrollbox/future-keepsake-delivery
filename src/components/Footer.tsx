          ...
          <div className="border-t border-background/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-4 mt-4 md:mt-0">
                <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-background hover:text-primary transition-colors">
                ...
                <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-background hover:text-primary transition-colors">
                ...
                <a href="https://linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-background hover:text-primary transition-colors">
                ...
                <a href="https://vimeo.com/" target="_blank" rel="noopener noreferrer" aria-label="Vimeo" className="text-background hover:text-primary transition-colors">
                ...
                <a href="https://github.com/" target="_blank" rel="noopener noreferrer" aria-label="Github" className="text-background hover:text-primary transition-colors">
                ...
                <a href="https://wa.me/" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-background hover:text-primary transition-colors">
