    ...
    <div className="mb-16">
      <Card className="bg-white shadow-lg max-w-4xl mx-auto border border-border">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl text-muted-foreground-dark">Como Tornar-se Parceiro</CardTitle>
        </CardHeader>
        <CardContent className="p-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-muted rounded-full text-foreground flex items-center justify-center mx-auto mb-4 font-bold">
                1
              </div>
