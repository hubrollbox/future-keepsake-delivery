      ...
      <div className="grid md:grid-cols-3 gap-6 md:gap-8">
        <Card className="emotion-card text-center p-6 md:p-8 hover:shadow-soft hover:scale-105 transition-all duration-300 border border-dusty-rose/20 group">
          <CardContent className="pt-6">
            ...
            <h3 className="font-bold mb-2 md:mb-3 text-lg md:text-xl text-steel-blue font-fraunces">Presente Físico</h3>
        ...
        <Card className="emotion-card text-center p-6 md:p-8 hover:shadow-soft hover:scale-105 transition-all duration-300 border border-dusty-rose/20 group">
          <CardContent className="pt-6">
            ...
            <h3 className="font-bold mb-2 md:mb-3 text-lg md:text-xl text-steel-blue font-fraunces">Mensagem Digital</h3>
            <p className="text-misty-gray text-sm md:text-base mb-3 md:mb-4 leading-relaxed">
        ...
        <Card className="emotion-card text-center p-6 md:p-8 hover:shadow-soft hover:scale-105 transition-all duration-300 border border-dusty-rose/20 group">
          <CardContent className="pt-6">
            ...
            <h3 className="font-bold mb-2 md:mb-3 text-lg md:text-xl text-steel-blue font-fraunces">Cápsula do Tempo</h3>
            <p className="text-misty-gray text-sm md:text-base mb-3 md:mb-4 leading-relaxed">
