        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-6 justify-center mb-7 md:mb-12">
            ...
            <Button 
              variant="outline" 
              size="lg" 
              className="px-8 py-5 text-base md:text-lg min-h-[48px] md:min-h-[56px] bg-white border-2 border-keepla-black text-keepla-black hover:bg-keepla-black/10 hover:text-keepla-black transition-all duration-200 focus-visible:ring-2 focus-visible:ring-keepla-black/30"
