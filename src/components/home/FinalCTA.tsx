...
const FinalCTA = () => {
  ...
  return (
    <section className="py-10 md:py-28 bg-sand-beige relative" aria-label="Convite final para criar conta no FuturoPresente">
      {/* Detalhe decorativo suave com gradiente rosa */}
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        <div className="w-3/4 h-28 md:h-56 bg-dusty-rose/20 blur-3xl rounded-full absolute left-1/2 top-0 -translate-x-1/2" />
      </div>
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-lg md:text-2xl mb-4 md:mb-6 leading-relaxed max-w-3xl mx-auto font-fraunces italic text-dusty-rose">
            Presente no futuro
          </p>
          
          <p className="text-base md:text-xl mb-5 md:mb-8 leading-relaxed max-w-3xl mx-auto text-steel-blue/90 font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-3 md:gap-6 justify-center mb-7 md:mb-12">
            ...
            <Button 
              ...
              size="lg" 
              className="px-8 py-5 text-base md:text-lg min-h-[48px] md:min-h-[56px] border-earthy-burgundy text-earthy-burgundy hover:bg-dusty-rose/10 hover:text-earthy-burgundy transition-all duration-200 focus-visible:ring-2 focus-visible:ring-dusty-rose"
          ...
          <div className="flex flex-col sm:flex-row gap-5 md:gap-8 justify-center items-center text-misty-gray">
