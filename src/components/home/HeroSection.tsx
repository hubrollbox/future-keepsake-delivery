    ...
    >
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-xl md:text-3xl text-dusty-rose font-fraunces italic mb-5 md:mb-8">
            Presente no futuro
          </p>

          {/* Story Introduction */}
          <div className="max-w-4xl mx-auto mb-6 md:mb-12">
            <p className="text-base md:text-xl text-steel-blue mb-4 md:mb-6 leading-relaxed font-medium" style={{ textShadow: "0 1px 0 #ECE5DA" }}>
          ...
          {/* CTA Buttons */}
          <div className="flex flex-col sm:flex-row gap-3 md:gap-6 justify-center items-center mb-7 md:mb-16">
            <Button 
              size="lg" 
              variant="brand"
            ...
            <Button 
              ...
              size="lg" 
              className="px-8 py-5 text-base md:text-lg min-h-[48px] md:min-h-[60px] transition-all duration-200 border-2 border-earthy-burgundy focus-visible:ring-2 focus-visible:ring-dusty-rose"
