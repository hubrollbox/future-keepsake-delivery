    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <Label htmlFor="name" className="text-muted-foreground-dark font-medium">
            Nome *
          </Label>
          <Input
            id="name"
        ...
        <div className="space-y-2">
          <Label htmlFor="email" className="text-muted-foreground-dark font-medium">
            Email *
          </Label>
          <Input
            id="email"
      ...
      <div className="space-y-2">
        <Label htmlFor="subject" className="text-muted-foreground-dark font-medium">
          Assunto *
        </Label>
        <Input
          id="subject"
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          className={cn(
            "min-h-[120px] border-border-light focus:border-primary resize-none",
