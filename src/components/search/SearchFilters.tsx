    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted-foreground-light h-4 w-4" />
          <Input
        ...
        <div className="flex gap-2">
          ...
          >
            ...
            {getActiveFiltersCount() > 0 && (
              <div className="ml-1 h-5 w-5 flex items-center justify-center p-0 text-xs bg-muted-light text-muted-foreground-dark rounded-full">
          ...
          {hasActiveFilters && (
            <Button
              ...
              className="flex items-center gap-2 text-muted-foreground-light hover:text-muted-foreground-dark"
            >
              <X className="h-4 w-4" />
              Limpar
            </Button>
      ...
      {hasActiveFilters && (
        <div className="flex flex-wrap gap-2">
          {filters.searchTerm && (
            <div className="inline-flex items-center rounded-full border border-transparent bg-muted-light text-muted-foreground-dark px-2.5 py-0.5 text-xs font-semibold gap-1">
          ...
          <CardContent className="p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground-dark">Estado</label>
                <div>
                  <SelectTrigger
              ...
              {/* Date From Filter */}
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground-dark">Data Inicial</label>
              ...
              {/* Date To Filter */}
              <div className="space-y-2">
                <label className="text-sm font-medium text-muted-foreground-dark">Data Final</label>
                <div className="relative">
                  <Button
                    variant="outline"
                    className="w-full justify-start text-left font-normal"
              ...
              {showCategoryFilter && (
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground-dark">Categoria</label>
                  <div>
                    <SelectTrigger
              ...
              {showUserTypeFilter && (
                <div className="space-y-2">
                  <label className="text-sm font-medium text-muted-foreground-dark">Tipo de Utilizador</label>
                  <div>
                    <SelectTrigger
